...
public class DatabaseInitializer(ActivitySource activitySource, ILogger<DatabaseInitializer> logger)
{
    ...
    {
        using var activity = activitySource.StartActivity("DatabaseInitialization", ActivityKind.Internal);
        ...
        else
        {
            ...
            using var migrateActivity = activitySource.StartActivity("ApplyMigrations", ActivityKind.Internal);
