...
namespace MattEland.Jaimes.Repositories.Migrations
{
    ...
    [Migration("20251213213156_AddInitialGreetingToScenario")]
    partial class AddInitialGreetingToScenario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MattEland.Jaimes.Repositories.Entities.Scenario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InitialGreeting = "We're about to get started on a solo adventure, but before we do, tell me a bit about your character and the style of adventure you'd like to have",
                            Name = "Island Test",
