...
namespace MattEland.Jaimes.Repositories.Migrations
{
    ...
    [Migration("20260104180656_AddClassifierTrainingJob")]
    partial class AddClassifierTrainingJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MattEland.Jaimes.Repositories.Entities.ClassificationModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ClassificationModels");
                });

            modelBuilder.Entity("MattEland.Jaimes.Repositories.Entities.ClassificationModelTrainingJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ClassificationModelId")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("OptimizingMetric")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.Property<int?>("TestRows")
                        .HasColumnType("integer");

                    b.Property<int?>("TotalRows")
                        .HasColumnType("integer");

                    b.Property<double>("TrainTestSplit")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("ClassificationModelTrainingJobs");
                });
            ...
            modelBuilder.Entity("MattEland.Jaimes.Repositories.Entities.ClassificationModel", b =>
                {
                    b.HasOne("MattEland.Jaimes.Repositories.Entities.StoredFile", "StoredFile")
                        .WithMany()
                        .HasForeignKey("StoredFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MattEland.Jaimes.Repositories.Entities.ClassificationModelTrainingJob", "TrainingJob")
                        .WithOne("ClassificationModel")
                        .HasForeignKey("MattEland.Jaimes.Repositories.Entities.ClassificationModel", "TrainingJobId")
            ...
            modelBuilder.Entity("MattEland.Jaimes.Repositories.Entities.ClassificationModelTrainingJob", b =>
                {
                    b.Navigation("ClassificationModel");
                });
