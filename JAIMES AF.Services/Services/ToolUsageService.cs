    ...
    IMessageService messageService) : IToolUsageService
{
        ...
        List<ToolCallDetailDto> items = toolCalls.Select(mtc =>
            {
                ...
                return new ToolCallDetailDto
                {
                    ...
                    GameName = gameName,
                    AgentId = mtc.InstructionVersion?.AgentId,
                    InstructionVersionId = mtc.InstructionVersionId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new ToolCallFullDetailResponse
        {
            ...
            GameName = gameName,
            AgentId = toolCall.InstructionVersion?.AgentId,
            InstructionVersionId = toolCall.InstructionVersionId,
